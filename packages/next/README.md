...
Exports generated route implementations, server data loaders, theme types, UI primitives, proxy auth helpers, and templates used by `@silicajs/cli` to materialize `.silica/next/`.
